...
function MusicPlayer() {
    return (
        <div className="player h-[95vh] flex flex-col items-center justify-center transition-colors duration-500">
            {/* Details Section */}
            <div className="details flex flex-col items-center justify-center mt-6 border p-4 sm:p-6 rounded-lg shadow-2xl bg-emerald-500 w-[90vw] sm:w-[50vw] md:w-[30vw] lg:w-[20vw] h-auto sm:h-[60vh]">
                <div className="now-playing text-xs sm:text-sm">PLAYING x OF y</div>
                <div className="track-art my-4 sm:my-6 h-[150px] sm:h-[250px] w-[150px] sm:w-[250px] bg-cover bg-center rounded-[15%]">
                    <img className="rounded-full" src="image_1.webp" alt="Album Art" />
                </div>
